...
namespace TextTableParser
{
    public class TableToDtoConverterFactory
    {
        ...
        private static Expression CreateIfNotEmtyConvertMethodCall<T>(string method, ParameterExpression param) where T: struct =>
            Expression.Condition(Expression.Call(typeof(string).GetMethod("IsNullOrEmpty"), param),
                                                     Expression.TypeAs(Expression.Constant((int?)null),
                                                                       typeof(T?)),
                                                     Expression.TypeAs(Expression.Call(typeof(Convert).GetMethod(method, new[] { typeof(string) }), param),
                                                                       typeof(T?)));
        ...
        static TableToDtoConverterFactory()
        {
            ...
            _converterFactoryMethods[typeof(double)] = param => CreateDirectConvertMethodCall("ToDouble", param);
            _converterFactoryMethods[typeof(double?)] = param => CreateIfNotEmtyConvertMethodCall<double>("ToDouble", param);
            ...
            _converterFactoryMethods[typeof(float)] = param => CreateDirectConvertMethodCall("ToSingle", param);
            _converterFactoryMethods[typeof(float?)] = param => CreateIfNotEmtyConvertMethodCall<float>("ToSingle", param);
